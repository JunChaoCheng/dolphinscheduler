...
DolphinScheduler is based on a lot of excellent open-source projects, such as Google guava, grpc, , quartz, and many open-source projects of Apache and so on.
